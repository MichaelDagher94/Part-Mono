...
@Component({
  selector: "app-guarantees-complete-cover-foresight",
  imports: [MatExpansionModule, MatIconModule, MatButtonModule],
  templateUrl: "./guarantees-complete-cover-foresight.component.html",
  styleUrl: "./guarantees-complete-cover-foresight.component.scss",
})
export class GuaranteesCompleteCoverForesightComponent {
