...
const base = "https://staging.ipeca.fr/";
const baseUrl = "https://staging.myipeca-api.ipeca.fr/api/";
const baseUrlV1 = "https://staging.myipeca-api.ipeca.fr/api/v1/";
const baseUrlV2 = "https://staging.myipeca-api.ipeca.fr/api/v2/";
const basePath = "https://staging.ipeca.fr/ng/";
