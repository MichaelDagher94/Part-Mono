...
const base = "https://ipeca.fr/";
const baseUrl = "https://myipeca-api.ipeca.fr/api/";
const baseUrlV1 = "https://myipeca-api.ipeca.fr/api/v1/";
const baseUrlV2 = "https://myipeca-api.ipeca.fr/api/v2/";
const basePath = "https://www.ipeca.fr/ng/";
